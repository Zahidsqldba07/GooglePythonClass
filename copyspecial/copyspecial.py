# !/usr/bin/env python3
"""
created: 2022-04-24 09:59:27
@author: seraph776
contact: seraph776@gmail.com
project: Google Python Class - Copy Special exercise

metadoc: TASK-1: get_special_path(): Find all "special files" and list them by their absolute paths.
         ...
         TASK-2: copy_to_directory(): Create a function that takes two arguments (src, dest). Move all special files to
         destination folder. If the folder does not exist, create it.

         TASK-3: zip_special_files(): Create a function that takes 1 argument (zip_name) that find all "special files"
